# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 16:19:20 2024
...
st.title("Brain Tumor Detection :brain:")
st.write("""
This application detects, outlines, and computes the area and perimeter of brain tumors in MRI images.
Upload an MRI image to see the processing steps and the final result.
""")
